...
3.  **Rotation propre ($\\phi$)** : rotation du solide sur lui-même.`,
  ...
  }, // --- ÉLECTROMAGNÉTISME L2 (ID: l2-em-1 à l2-em-6) ---
  ...
  'l2-em-1': {
    ...
    difficulty: 3,
    duration: '75 min',
    tags: ['Coulomb', 'Gauss', 'Flux'],
    intro: "Cette première partie pose les bases du champ électrique créé par des charges statiques, en utilisant la force de Coulomb et le puissant théorème de Gauss.",
    sections: [
      {
        id: 's1',
        title: '1. Loi de Coulomb et Champ E',
        content: `La force entre deux charges ponctuelle $q_1$ et $q_2$ est donnée par :
$$\\vec{F} = \\frac{1}{4\\pi\\epsilon_0} \\frac{q_1 q_2}{r^2} \\vec{u}_{12}$$
Le champ électrique $\\vec{E}$ en un point $M$ est le champ de force par unité de charge : $\\vec{E} = \\vec{F}/q$.`,
      },
      {
        id: 's2',
        title: '2. Théorème de Gauss',
        content: `Le flux du champ électrique à travers une surface fermée $S$ est proportionnel à la charge intérieure :
$$\\Phi = \\oint_S \\vec{E} \\cdot d\\vec{S} = \\frac{Q_{int}}{\\epsilon_0}$$
C'est l'outil fondamental pour calculer le champ $\\vec{E}$ dès qu'il y a une symétrie (sphérique, cylindrique ou plane).`,
      }
    ],
  },
  ...
  'l2-em-2': {
    ...
    intro: "Le champ électrique est conservatif, ce qui permet de définir un potentiel scalaire V. Manipuler des nombres (potentiel) est souvent plus simple que de manipuler des vecteurs (champ).",
    sections: [
      {
        id: 's1',
        title: '1. Relation Champ-Potentiel',
        content: `Le champ électrique dérive du potentiel scalaire : $\\vec{E} = -\\vec{grad}(V)$. 
En conséquence, les lignes de champ sont toujours perpendiculaires aux surfaces équipotentielles et dirigées vers les potentiels décroissants.`,
      }
    ],
  },
  ...
  'l2-em-3': {
    ...
    difficulty: 4,
    duration: '80 min',
    tags: ['Biot-Savart', 'Champ B', 'Ampère'],
    intro: "Nous passons ici aux charges en mouvement permanent (courants). Ces courants génèrent un champ magnétique $\\vec{B}$ décrit par la loi de Biot-Savart.",
    sections: [
      {
        id: 's1',
        title: '1. Loi de Biot-Savart',
        content: `Pour un élément de circuit $d\\vec{l}$ parcouru par un courant $I$, le champ magnétique élémentaire en $M$ est :
$$d\\vec{B}(M) = \\frac{\\mu_0 I}{4\\pi} \\frac{d\\vec{l} \\wedge \\vec{PM}}{r^3}$$
Le champ $\\vec{B}$ est toujours perpendiculaire au plan contenant le courant et le point d'observation.`,
      }
    ],
  },
  ...
  'l2-em-4': {
    ...
    difficulty: 4,
    duration: '75 min',
    tags: ['Faraday', 'Lenz', 'Induction'],
    intro: "L'induction est le couplage entre électricité et magnétisme : un champ magnétique variable dans le temps crée un champ électrique et donc un courant.",
    sections: [
      {
        id: 's1',
        title: '1. Loi de Faraday et de Lenz',
        content: `La force électromotrice (f.e.m.) induite dans un circuit est égale à l'opposé de la variation du flux magnétique :
$$e = -\\frac{d\\Phi}{dt}$$
Le signe $-$ (Loi de Lenz) indique que les effets de l'induction s'opposent à la cause qui leur a donné naissance.`,
      }
    ],
  },
  ...
  'l2-em-5': {
    ...
    difficulty: 5,
    duration: '90 min',
    tags: ['Maxwell', 'Analyse Vectorielle', 'Synthèse'],
    intro: "C'est le coeur du sujet : la synthèse de l'électromagnétisme en quatre équations différentielles qui unifient les champs E et B.",
    sections: [
      {
        id: 's1',
        title: '1. Les 4 Équations Fondamentales',
        content: `Dans le vide (hors sources), elles s'écrivent :
1. $div \\vec{E} = 0$ (Maxwell-Gauss)
2. $div \\vec{B} = 0$ (Maxwell-Thomson)
3. $\\vec{rot} \\vec{E} = -\\frac{\\partial \\vec{B}}{\\partial t}$ (Maxwell-Faraday)
4. $\\vec{rot} \\vec{B} = \\mu_0\\epsilon_0 \\frac{\\partial \\vec{E}}{\\partial t}$ (Maxwell-Ampère)`,
      }
    ],
  },
  ...
  'l2-em-6': {
    ...
    intro: "Démonstration que les champs E et B se propagent sous forme d'ondes à la vitesse de la lumière. Étude des propriétés de ces ondes et du transport d'énergie.",
    sections: [
      {
        id: 's1',
        title: '1. Structure de l\'OPPM',
        content: `Pour une onde plane progressive monophasique (OPPM), $\\vec{E}$ et $\\vec{B}$ sont perpendiculaires entre eux et à la direction de propagation $\\vec{k}$. 
On a la relation de structure : $\\vec{B} = \\frac{\\vec{k} \\wedge \\vec{E}}{\\omega}$.`,
      }
    ],
  },
}
