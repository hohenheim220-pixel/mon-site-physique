...
3.  **Rotation propre ($\\phi$)** : rotation du solide sur lui-même.`,
  ...
  }, // --- ÉLECTROMAGNÉTISME L2 (COMPLET AVEC EXERCICES) ---
  ...
  'l2-em-1': {
    ...
    intro: "Cette première partie pose les bases du champ électrique créé par des charges statiques.",
    sections: [
      {
        id: 's1',
        title: '1. Théorème de Gauss',
        content: `Le flux du champ électrique à travers une surface fermée $S$ est : $\\oint_S \\vec{E} \\cdot d\\vec{S} = \\frac{Q_{int}}{\\epsilon_0}$.`
      }
    ],
    exercises: [
      {
        id: 'ex1',
        title: 'Sphère chargée en surface',
        difficulty: 3,
        statement: "Calculer le champ électrique $E$ à l'extérieur d'une sphère de rayon $R$ portant une charge totale $Q$ répartie en surface.",
        solution: "Par symétrie, $\\vec{E}$ est radial. En choisissant une sphère de Gauss de rayon $r > R$ : $E \\cdot (4\\pi r^2) = Q/\\epsilon_0$. Soit $E(r) = \\frac{Q}{4\\pi\\epsilon_0 r^2}$."
      }
    ]
  },
  ...
  'l2-em-2': {
    ...
    intro: "Le potentiel scalaire $V$ permet de décrire l'état électrique de l'espace plus simplement que le champ vectoriel.",
    sections: [
      {
        id: 's1',
        title: '1. Énergie potentielle',
        content: "L'énergie d'une charge $q$ dans un potentiel $V$ est $E_p = qV$."
      }
    ],
    exercises: [
      {
        ...
        difficulty: 2,
        statement: "Un électron ($q = -e$) est accéléré par une différence de potentiel $U = 1000\\,V$. Quelle est son énergie cinétique acquise ?",
        solution: "$\\Delta E_c = -\\Delta E_p = -(-e \\cdot U) = e \\cdot U = 1000\\,eV$ (électron-volts)."
      }
    ]
  },
  ...
  'l2-em-3': {
    ...
    intro: "Étude du champ magnétique créé par des courants stationnaires.",
    sections: [
      {
        id: 's1',
        title: '1. Théorème d\'Ampère',
        content: "$\\oint \\vec{B} \\cdot d\\vec{l} = \\mu_0 I_{enlacé}$."
      }
    ],
    exercises: [
      {
        ...
        difficulty: 3,
        statement: "Calculer le champ $B$ au centre d'un solénoïde infini ayant $n$ spires par mètre parcourues par un courant $I$.",
        solution: "En appliquant le théorème d'Ampère sur un contour rectangulaire, on trouve $B = \\mu_0 n I$."
      }
    ]
  },
  ...
  'l2-em-4': {
    ...
    intro: "Lien entre la variation d'un champ magnétique et l'apparition d'une force électromotrice.",
    sections: [
      {
        id: 's1',
        title: '1. Loi de Lenz',
        content: "Le courant induit s'oppose par ses effets à la cause qui lui donne naissance."
      }
    ],
    exercises: [
      {
        id: 'ex1',
        title: 'Variation de flux',
        difficulty: 4,
        statement: "Une spire de surface $S=0,01\\,m^2$ est placée dans un champ $B$ qui passe de $0$ à $0,5\\,T$ en $0,1\\,s$. Quelle est la f.e.m. induite ?",
        solution: "$|e| = |\\frac{d\\Phi}{dt}| = S \\cdot \\frac{\\Delta B}{\\Delta t} = 0,01 \\cdot (0,5 / 0,1) = 0,05\\,V$."
      }
    ]
  },
  ...
  'l2-em-5': {
    ...
    intro: "Les quatre équations fondamentales qui unifient l'électromagnétisme.",
    sections: [
      {
        id: 's1',
        title: '1. Courant de déplacement',
        content: "Maxwell a ajouté le terme $\\epsilon_0\\mu_0 \\frac{\\partial E}{\\partial t}$ à la loi d'Ampère pour assurer la conservation de la charge."
      }
    ],
    exercises: [
      {
        id: 'ex1',
        title: 'Interprétation de Maxwell-Gauss',
        difficulty: 3,
        statement: "Que signifie physiquement l'équation $div \\vec{B} = 0$ ?",
        solution: "Elle signifie que le flux magnétique est conservatif et qu'il n'existe pas de 'charge magnétique' (monopôle) isolée."
      }
    ]
  },
  ...
  'l2-em-6': {
    ...
    intro: "Étude de la propagation de l'énergie électromagnétique dans l'espace.",
    sections: [
      {
        id: 's1',
        title: '1. Vecteur de Poynting',
        content: "$\\vec{\\Pi} = \\frac{\\vec{E} \\wedge \\vec{B}}{\\mu_0}$ représente la densité de flux d'énergie."
      }
    ],
    exercises: [
      {
        ...
        title: 'Relation E/B',
        difficulty: 2,
        statement: "Dans une onde plane dans le vide, si $E = 300\\,V/m$, quelle est la valeur de $B$ ?",
        solution: "$B = E/c = 300 / (3 \\cdot 10^8) = 10^{-6}\\,T = 1\\,\\mu T$."
      }
    ]
  },
}
