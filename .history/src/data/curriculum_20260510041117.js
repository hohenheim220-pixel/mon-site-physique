...
$$ I = I_0 \\cos^2(\\alpha) $$`,
  ...
  }, // --- MÉCANIQUE QUANTIQUE L3 : L'ÉTUDE COMPLÈTE DU PUITS INFINI ---
  'l3-qm-2': {
    title: "Équation de Schrödinger — puits infini",
    level: 'l3',
    difficulty: 4,
    duration: '120 min',
    tags: ['Schrödinger', 'Puits de Potentiel', 'Quantification', 'Probabilités'],
    intro: "Le puits infini est le modèle de base du confinement. On y apprend que l'énergie ne peut pas être quelconque et que la particule ne peut pas être n'importe où.",
    sections: [
      {
        id: 's1',
        title: '1. L\'Équation de Schrödinger dans le puits',
        content: `À l'intérieur du puits (entre $0$ et $L$), le potentiel $V(x)$ est nul. L'équation de Schrödinger devient :

$$ -\\frac{\\hbar^2}{2m} \\frac{d^2\\psi(x)}{dx^2} = E\\psi(x) $$

C'est une équation différentielle dont les solutions sont des fonctions sinus et cosinus. Mais attention, les 'murs' du puits à $x=0$ et $x=L$ imposent que la fonction d'onde s'écrase : $\\psi(0) = 0$ et $\\psi(L) = 0$.`,
      },
      {
        id: 's2',
        title: '2. Fonctions propres et Normalisation',
        content: `Pour satisfaire les conditions aux bords, la solution doit être :
$$ \\psi_n(x) = A \\sin\\left(\\frac{n\\pi x}{L}\\right) $$

**La Normalisation :** En mécanique quantique, la probabilité totale de trouver la particule dans le puits doit être de 100% (soit 1). On calcule $A$ tel que :
$$ \\int_0^L |\\psi_n(x)|^2 dx = 1 \\implies A = \\sqrt{\\frac{2}{L}} $$

Chaque valeur de $n$ (1, 2, 3...) correspond à un 'état' différent de la particule.`,
      },
      {
        id: 's3',
        title: '3. Niveaux d\'énergie quantifiés',
        content: `C'est le résultat le plus important. L'énergie est "piégée" sur des niveaux précis :

$$ E_n = \\frac{n^2 \\pi^2 \\hbar^2}{2mL^2} $$

- **n=1 (État fondamental)** : L'énergie la plus basse. Elle n'est pas nulle !
- **n=2, 3... (États excités)** : L'énergie grimpe très vite (selon le carré de $n$).`,
      },
      {
        id: 's4',
        title: '4. Probabilité de présence',
        content: `Le carré de la fonction d'onde $|\\psi_n(x)|^2$ nous dit où la particule aime se cacher. 
- Au niveau $n=1$, elle est surtout au centre.
- Au niveau $n=2$, elle a une probabilité nulle d'être exactement au milieu (c'est ce qu'on appelle un **noeud**).`,
      }
    ],
    exercises: [
      {
        id: 'ex1',
        title: 'Le saut d\'énergie',
        difficulty: 4,
        statement: "Calculer l'énergie nécessaire pour faire passer un électron du niveau $n=1$ au niveau $n=2$ dans un puits de $1\\,nm$.",
        solution: "$\\Delta E = E_2 - E_1 = (4 - 1) \\frac{\\pi^2 \\hbar^2}{2mL^2} = 3 E_1$. Avec les valeurs numériques, on trouve environ $1,13\\,eV$."
      },
      {
        id: 'ex2',
        title: 'Analyse du Noeud',
        difficulty: 3,
        statement: "Pour $n=2$, calculez la probabilité de trouver la particule entre $x=0,45L$ et $x=0,55L$.",
        solution: "Comme $\\psi_2(L/2) = 0$, la probabilité est extrêmement faible (proche de 0) car le centre est un noeud pour cet état."
      }
    ]
  },
}
