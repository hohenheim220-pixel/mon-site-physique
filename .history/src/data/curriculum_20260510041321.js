...
$$ I = I_0 \\cos^2(\\alpha) $$`,
    ...
    difficulty: 5,
    duration: '120 min',
    tags: ['Schrödinger', 'Énergie Cinétique', 'Puits Infini'],
    intro: "Maîtrisez l'équation fondamentale de la matière et voyez comment elle impose des niveaux d'énergie discrets dans un système confiné.",
    sections: [
      {
        id: 's1',
        title: '1. Anatomie de l\'Équation de Schrödinger',
        content: `L'équation stationnaire est une équation aux valeurs propres de l'Hamiltonien $\\hat{H}\\psi = E\\psi$.
        
**Décryptage mathématique :**
- Le terme $-\\frac{\\hbar^2}{2m} \\frac{d^2}{dx^2}$ représente l'énergie cinétique. Mathématiquement, c'est la **courbure** de la fonction d'onde. Plus $\\psi$ ondule, plus la particule est 'énergétique'.
- Le terme $V(x)$ représente l'énergie potentielle (les forces extérieures).
- $E$ est l'énergie totale autorisée. Si l'équation n'a pas de solution pour une valeur de $E$, cette énergie est strictement **interdite**.`
      },
      {
        id: 's2',
        title: '2. Application : Le Puits Infini',
        content: `Dans un puits de largeur $L$ où $V=0$ :
1. **À l'intérieur** : La particule est libre, $\\psi(x)$ est une onde sinusoïdale.
2. **Aux bords** : Le potentiel infini force $\\psi(0)=0$ et $\\psi(L)=0$.
        
Cette contrainte impose la forme des solutions :
$$ \\psi_n(x) = \\sqrt{\\frac{2}{L}} \\sin\\left(\\frac{n\\pi x}{L}\\right) $$
C'est ici que naît la **quantification** : seuls certains modes de vibration sont possibles, comme sur une corde de piano.`
      },
      {
        id: 's3',
        title: '3. Les Niveaux d\'Énergie',
        content: `En réinjectant la solution dans l'équation de Schrödinger, on trouve :
$$ E_n = \\frac{n^2 \\pi^2 \\hbar^2}{2mL^2} $$
On remarque que l'énergie dépend de $1/L^2$ : plus on comprime la particule, plus son énergie minimale augmente violemment. C'est une manifestation directe du principe d'incertitude d'Heisenberg.`
      }
    ]
  },
}
