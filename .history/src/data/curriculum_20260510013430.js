...
}, SOMMAIRE DU CHAPITRE 3 : THERMODYNAMIQUE
Page 1 : Description d'un système et Modèle du Gaz Parfait ................. 1
Page 2 : Le Premier Principe : Énergie interne et Transferts ................... 2
Page 3 : Le Second Principe : Entropie et Irréversibilité .......................... 3
Page 4 : DÉMONSTRATION : Loi de refroidissement de Newton .............. 4
Page 5 : Machines thermiques et Cycles de transformation ................... 5
Page 6 : TP & PYTHON : Simulation d'une évolution thermique ................ 6
Page 7 : EXERCICE CORRIGÉ : Bilan d'un système incompressible ......... 7

--------------------------------------------------------------------------------
[Page 1]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 1 / 7
1. Système et variables d'état
Un système thermodynamique est une portion d'espace délimitée par une frontière
. Il est caractérisé par des variables :
Intensives : Indépendantes de la taille du système (Pression P, Température T)
.
Extensives : Proportionnelles à la quantité de matière (Volume V, Masse m, Énergie interne U)
.
2. Le Modèle du Gaz Parfait
Le gaz parfait est un modèle simplifié où l'on néglige les interactions intermoléculaires et le volume propre des molécules
. Il suit l'équation d'état fondamentale : 
PV=nRT
P en Pascals (Pa), V en m 
3
 , T en Kelvins (K)
.
R≈8,314 J.K 
...
--------------------------------------------------------------------------------
[Page 2]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 2 / 7
3. Le Premier Principe : Conservation de l'Énergie
L'énergie totale d'un système au repos macroscopique est appelée énergie interne U
. Elle correspond à la somme des énergies cinétiques et potentielles microscopiques des entités
.
Énoncé : La variation de l'énergie interne ΔU lors d'une transformation est égale à la somme du travail W et de la chaleur Q échangés avec l'extérieur
 : 
ΔU=W+Q
Pour un système incompressible (solide ou liquide), la variation d'énergie interne dépend uniquement de la température : ΔU=m⋅C⋅ΔT (où C est la capacité thermique massique)
.

--------------------------------------------------------------------------------
[Page 3]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 3 / 7
4. Le Second Principe et l'Entropie
Alors que le premier principe impose la conservation, le second principe impose le sens de l'évolution
. On introduit une fonction d'état, l'entropie S, qui mesure le "désordre" du système
.
Pour un système isolé, l'entropie ne peut qu'augmenter (ΔS 
isol 
e
ˊ
...
​
 ≥0)
.
Approche Statistique (L3) : L'entropie est reliée au nombre de micro-états accessibles Ω par la formule de Boltzmann : S=k 
B
​
 ln(Ω)
.
...
--------------------------------------------------------------------------------
[Page 4]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 4 / 7
5. DÉMONSTRATION : Loi phénoménologique de Newton
L'objectif est de modéliser l'évolution de la température T(t) d'un corps au contact d'un thermostat de température T 
ext
​
...
dU
​
 =Φ (où Φ est le flux thermique)
.
Modèle : Pour un corps incompressible,  
dt
dU
​
 =m⋅C⋅ 
...
.
Loi de Newton : Le flux est proportionnel à l'écart de température : Φ=−h⋅S⋅(T(t)−T 
ext
​
 )
.
...
Solution : En posant τ= 
h⋅S
m⋅C
​
  (temps caractéristique), la solution est : 
T(t)=T 
ext
​
 +(T 
...
−t/τ
 ...
 La température rejoint exponentiellement celle du thermostat
.

--------------------------------------------------------------------------------
[Page 5]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 5 / 7
6. Machines Thermiques (Niveau Licence)
Une machine thermique échange de la chaleur avec deux sources pour produire du travail (moteur) ou en consommer (pompe à chaleur, réfrigérateur)
.
Rendement d'un moteur : η= 
Q 
chaude
​
...
​
 .
Cycle de Carnot : C'est le cycle théorique réversible offrant le rendement maximal entre deux températures T 
c
​
  et T 
f
...
--------------------------------------------------------------------------------
[Page 6]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 6 / 7
7. PYTHON : Simulation du refroidissement d'une tasse
Ce script permet de visualiser la loi de Newton démontrée en page 4.
import numpy as np
import matplotlib.pyplot as plt

# Données : Tasse de café
T_ext = 20.0  # Température ambiante (°C)
T0 = 80.0     # Température initiale du café
tau = 300.0   # Temps caractéristique (s)

t = np.linspace(0, 1500, 100)
T = T_ext + (T0 - T_ext) * np.exp(-t / tau)

plt.plot(t, T, 'r-', label="Refroidissement (Loi de Newton)")
plt.axhline(y=T_ext, color='b', linestyle='--', label="Thermostat (Ambiance)")
plt.xlabel("Temps (s)")
plt.ylabel("Température (°C)")
plt.legend()
plt.title("Évolution thermique d'un système")
plt.show()

--------------------------------------------------------------------------------
[Page 7]
Physique : de la Terminale à l'Université | Chapitre 3 : Thermodynamique | Page 7 / 7
8. EXERCICE CORRIGÉ
Énoncé : Une masse de 0,5 kg de fer initialement à 100 
∘
 C est plongée dans 1 kg d'eau à 20 
∘
 C. On donne C 
fer
​
...
−1
 .K 
−1
 . Déterminer la température finale d'équilibre T 
f
​
  (système calorifugé).
Corrigé :
Système isolé : La somme des chaleurs échangées est nulle : Q 
fer
​
 +Q 
eau
