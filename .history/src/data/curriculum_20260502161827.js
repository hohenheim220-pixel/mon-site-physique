...
export const LESSON_CONTENT = { 'newton-lois': {
...
On modélise l'objet par un **point matériel** de masse *m* concentrée en son centre de masse.`,
    ...
    },
    {
      ...
      content: `**1ère Loi — Principe d'inertie :** Dans un référentiel galiléen, si la somme des forces est nulle, le vecteur vitesse est constant (repos ou mouvement rectiligne uniforme).

**2ème Loi — Principe Fondamental de la Dynamique (PFD) :** La somme vectorielle des forces extérieures est égale au produit de la masse par l'accélération. C'est la loi centrale qui permet d'établir les équations différentielles du mouvement.

**3ème Loi — Action-Réaction :** Si A exerce une force sur B, alors B exerce sur A une force opposée, simultanée et de même norme.`,
      formulas: [
        {
          id: 'f4',
...
**Force unique :** attraction gravitationnelle F = GMm/r²

**Accélération centripète :** a = v²/r (mouvement circulaire uniforme)

**Application du PFD :**
G·Mm/r² = m·v²/r  ⟹  v² = GM/r

**Période T :** le satellite parcourt 2πr à la vitesse v :
T = 2πr/v  ⟹  T² = 4π²r²/v² = 4π²r²/(GM/r) = 4π²r³/GM
